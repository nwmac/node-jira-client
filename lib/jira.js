...
var JiraApi = function () {
  ...
  (0, _createClass3.default)(JiraApi, [{
    ...
    value: function listSprints(rapidViewId) {
      var includeFutureSprints = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      var includeHistoricSprints = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    ...
    */
    ...
    key: 'createSprint',
    value: function createSprint(body) {
    ...
    key: 'updateSprint',
    value: function updateSprint(sprintId, body) {
      return this.doRequest(this.makeRequestHeader(this.makeAgileUri({
    ...
    key: 'partiallyUpdateSprint',
    value: function partiallyUpdateSprint(sprintId, body) {
      return this.doRequest(this.makeRequestHeader(this.makeAgileUri({
        pathname: '/sprint/' + sprintId
      }), {
        method: 'POST',
    ...
    key: 'deleteSprint',
    value: function deleteSprint(sprintId) {
      return this.doRequest(this.makeRequestHeader(this.makeAgileUri({
        pathname: '/sprint/' + sprintId
      }), {
        method: 'DELETE'
    ...
    key: 'moveIssuesToSprint',
    value: function moveIssuesToSprint(sprintId, body) {
      return this.doRequest(this.makeRequestHeader(this.makeAgileUri({
    ...
    key: 'swapSprint',
    value: function swapSprint(sprintId, body) {
      return this.doRequest(this.makeRequestHeader(this.makeAgileUri({
    ...
    key: 'getSprintPropertiesKeys',
    value: function getSprintPropertiesKeys(sprintId) {
      return this.doRequest(this.makeRequestHeader(this.makeAgileUri({
    ...
    key: 'deleteSprintProperty',
    value: function deleteSprintProperty(sprintId, propertyKey) {
      return this.doRequest(this.makeRequestHeader(this.makeAgileUri({
    ...
    key: 'setSprintProperty',
    value: function setSprintProperty(sprintId, propertyKey, body) {
      return this.doRequest(this.makeRequestHeader(this.makeAgileUri({
        pathname: '/sprint/' + sprintId + '/properties/' + propertyKey
      }), {
        method: 'PUT',
    ...
    key: 'getSprintProperty',
    value: function getSprintProperty(sprintId, propertyKey) {
      return this.doRequest(this.makeRequestHeader(this.makeAgileUri({
        pathname: '/sprint/' + sprintId + '/properties/' + propertyKey
      })));
    }
